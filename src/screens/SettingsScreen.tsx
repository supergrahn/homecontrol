      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <View style={{ marginTop: 8, paddingVertical: 8 }}>
          ...
          <Button
            ...
            accessibilityHint={
              (t("hint.logOut") as string) || "Signs you out of this device."
            }
            variant="outline"
            onPress={async () => {
              try {
        ...
        <View style={{ marginTop: 8, paddingVertical: 8 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
            ...
            <Button
              ...
              onPress={() => {
                if (!i18n.language?.startsWith("no"))
        ...
        <View style={{ marginTop: 16, paddingVertical: 8 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Text style={{ flex: 1, color: theme.colors.text }}>
              {t("nightBeforeHint") ||
                "Send a preview of tomorrow around 20:00."}
            </Text>
            <Switch
              value={nightBefore}
        ...
        {households.map((h) => (
          ...
          >
            <TouchableOpacity
              ...
              accessibilityLabel={`Switch to household ${h.name || h.id}`}
            >
              <Text
                style={{
            ...
            <View style={{ flexDirection: "row", gap: 8, marginTop: 6 }}>
              {h.role === "admin" ? (
                <Button
                  ...
                  accessibilityHint={
                    (t("hint.deleteHousehold") as string) ||
                ...
                <Button
                  ...
                  accessibilityHint={
                    (t("hint.leaveHousehold") as string) ||
                    "Leaves this household."
                  }
                  onPress={() => {
                    Alert.alert(
              ...
              <Button
                ...
                onPress={async () => {
                  try {
                    ...
                    toast.show(
                      (t("filtersReset") as string) || "Filters reset",
                      {
                        type: "success",
                      }
                    );
                    ...
                    >
                      ...
                      {s.active ? (
                        <Button
                          ...
                          accessibilityHint={
                            (t("hint.revokeCalendarShare") as string) ||
                            "Revokes this calendar share."
                          }
                          onPress={async () => {
                            if (!householdId) return;
                            Alert.alert(
        ...
        {!!householdId ? (
          <View style={{ marginBottom: 8, marginTop: 16 }}>
            ...
            >
              ...
              <Switch
                value={digestUpcoming}
                onValueChange={setDigestUpcoming}
              />
            </View>
            <View
              style={{
                ...
                {isAdmin && m.userId !== auth.currentUser?.uid ? (
                  <View style={{ flexDirection: "row", gap: 8 }}>
                    <Button
                      ...
                      accessibilityHint={
                        (t("hint.makeAdmin") as string) ||
                        "Grants admin permissions to this member."
                      }
                      onPress={() => {
                        if (!householdId) return;
                        Alert.alert(
                    ...
                    {m.role === "admin" ? (
                      <Button
                        ...
                        accessibilityLabel={
                          t("demoteToAdult") || "Demote to adult"
                        }
                        accessibilityHint={
                          (t("hint.demote") as string) ||
                          "Removes admin permissions from this member."
                        }
                        onPress={() => {
                          if (!householdId) return;
                          Alert.alert(
                    ...
                    <Button
                      ...
                      accessibilityHint={
                        (t("hint.removeMember") as string) ||
                        "Removes this member from the household."
                      }
                      onPress={() => {
                        if (!householdId) return;
